...
//defined use
  ...
  #error "Uncomment the #define for either USE_WIFI101_SHIELD or USE_ETHERNET_SHIELD"
    ...
    #include <SPI.h>
    #include <Ethernet.h>
    byte mac[] = { 0x00, 0x1E, 0x06, 0x33, 0xAB, 0x0A};
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = "ABCDEF";
const char * myWriteAPIKey = "1234567891011121";
...
void loop() {
  ...
  delay(20000); // ThingSpeak will only accept updates every 15 seconds.
  ThingSpeak.writeField(myChannelNumber, 6, voltage, myWriteAPIKey);
  delay(20000); // ThingSpeak will only accept updates every 15 seconds.
}
